        ...
        <div class="my-gallery">
            <div class="col s12 m4 l2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                    <a href="{{ Voyager::image($post->image ) }}" itemprop="contentUrl" data-size="1920x1080">
                        <img src="{{ Voyager::image($post->thumbnail('medium') ) }}" class="responsive-img" itemprop="thumbnail" alt="Image description" />
                    </a>
